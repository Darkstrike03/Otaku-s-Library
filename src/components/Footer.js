...
export default function Footer({ isDark }) {
  ...
  const footerLinks = {
    browse: [
      ...
      { name: 'Novels', icon: Book },
      { name: 'Trending', icon: TrendingUp },
    ],
    community: [
      { name: 'Forums', icon: Users },
      { name: 'Reviews', icon: Star },
      { name: 'Lists', icon: Sparkles },
      { name: 'Recommendations', icon: Heart },
    ],
    company: [
      { name: 'About Us' },
      { name: 'Contact' },
            ...
            <div className="lg:col-span-2">
              ...
              <ul className="space-y-3">
                {footerLinks.browse.map((link) => {
                  ...
                  return (
                    <li key={link.name}>
                      <a href="#" className={`flex items-center gap-2 text-sm transition-all duration-300 group ${
                        isDark 
            ...
            <div className="lg:col-span-2">
              ...
              <ul className="space-y-3">
                {footerLinks.company.map((link) => (
                  <li key={link.name}>
                    <a href="#" className={`text-sm transition-all duration-300 inline-block group ${
                      isDark 
