...
export const metadata = {
  ...
  description: "Welcome back! Sign in to your Otaku's Library account to access your anime lists, manga collections, reviews, and personalized recommendations.",
  keywords: [
    'login',
    'sign in',
    'user login',
